...
function Footer() {
  return (
    <footer className="text-white bg-black [&_a]:block [&_a]:text-base [&_a]:leading-7 py-9 px-4 flex flex-col gap-y-7 lg:gap-y-20 lg:px-24 lg:pt-24 lg:pb-36">
      ...
      <section className="grid grid-cols-[repeat(auto-fit,_minmax(20rem,_1fr))] gap-y-8 gap-x-24">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <ul className="flex flex-col gap-y-3">
              <li className="flex items-center gap-x-2">
                ...
                <a href="mailto:Interairops@gmail.com">Interairops@gmail.com</a>
              </li>
              <li className="flex items-center gap-x-2">
                <div className="relative size-6">
                  <Image
        ...
        <div className="flex flex-col gap-y-2 lg:col-start-1 lg:row-start-1">
          ...
          <p className="max-w-72">
            ...
            over-flight and landing permits efficiently with a customer-focused
            approach.
          </p>
          <ul className="flex items-center gap-x-3 mt-1">
            ...
            <li>
              <a href="#" className="relative block size-5">
                <Image alt="x" src={"/x_logo.svg"} fill className="absolute" />
              </a>
            </li>
          </ul>
        </div>
