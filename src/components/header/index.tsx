...
function Header() {
  ...
  return (
    <header className="flex items-center justify-between bg-white py-2.5 px-5 relative lg:px-24 lg:py-4">
      ...
      <nav
        className={`${
          isOpen ? "absolute right-0 top-12 flex" : "hidden"
        } bg-white w-full flex-col gap-y-2 text-[#00000099] text-base leading-7 p-3 lg:flex-row lg:static lg:flex-1 lg:justify-end lg:gap-x-40`}
      >
